...
class BiblioU(Usuario):
    ...
    def registrar_libro(self,usuario):
        ...
        print("\t\t 3.Cronica")
        print("\t\t 4.Biografia")
        nuevo_libro.categoria = input("\t\t por favor escriba el número de categoria de su libro: ")
        int(nuevo_libro.categoria)
        while nuevo_libro.categoria != 1 and  nuevo_libro.categoria != 2 and nuevo_libro.categoria != 3 and  nuevo_libro.categoria != 1:
            print("\t\t Categoria Incorrecta")
            nuevo_libro.categoria = input("\t\t por favor escriba el número de categoria de su libro: ")
        if nuevo_libro.categoria == 1:
            print("Se ha guardado en la categoria Novela")
        elif nuevo_libro.categoria == 2:
            print("Su libro se ha guardado en Cuentos")
        elif nuevo_libro.categoria == 3:
